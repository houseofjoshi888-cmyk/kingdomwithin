...
const questions = [
  ...
  ["What does minting cost?", "The active Epoch price is read directly from the Base contract, plus Base network gas. The contract administrator can set the price for a current or future epoch. Your wallet always shows the transaction value before approval."],
