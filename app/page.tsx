  ...
  return (
    <main>
      <header className="topbar">
        ...
        <div className="top-actions"><Link href="/collection">COLLECTION</Link><Link href="/staking">STAKING</Link><Link href="/verify">VERIFY NFT</Link><Link href="/how-to-use">HOW TO USE</Link><WalletButton /></div>
      </header>
