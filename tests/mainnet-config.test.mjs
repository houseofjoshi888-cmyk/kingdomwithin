...
const files = ["app/providers.tsx", "app/page.tsx", "app/admin/page.tsx", "app/verify/page.tsx", "app/WalletButton.tsx", "lib/network.ts", "lib/contract.ts", "PROTOCOL.md", ".env.example"];
